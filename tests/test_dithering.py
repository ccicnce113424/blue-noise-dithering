...
class TestColorDistanceCalculator(unittest.TestCase):
    ...
    def test_cam16_ucs_distance(self):
        ...
        # Test basic properties
        # Distance from a color to itself should be 0
        self.assertAlmostEqual(calculator.calculate_distance(self.red, self.red), 0, places=10)
        self.assertAlmostEqual(calculator.calculate_distance(self.green, self.green), 0, places=10)
        self.assertAlmostEqual(calculator.calculate_distance(self.blue, self.blue), 0, places=10)
