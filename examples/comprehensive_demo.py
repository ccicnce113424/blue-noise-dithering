...
def demo_color_distance_methods():
    ...
    methods = [
        ...
        ('ciede2000_fast', 'Excellent quality with good performance'),
...
def main():
    ...
    try:
        ...
        print("- General use: --color-distance ciede2000_fast --adaptive-noise --adaptive-strategy gradient")
